 ...
 * result.  This is the sixth-arity specialization of {@link Consumer}.
 * Unlike most other functional interfaces, {@link HexConsumer} is expected
...
public interface HexConsumer<A, B, C, D, E, F> {
    ...
    /**
     * Returns a composed {@link HexConsumer} that performs, in sequence, this
