...
public interface IVec2DM extends IVec2D {
    ...
    IVec2DM lerp(int x, int y, double delta);
    IVec2DM lerp(double x, double y, double delta);
    IVec2DM lerp(IVec2IC vec, double delta);
    IVec2DM lerp(IVec2DC vec, double delta);
