...
public class Matrix2DM implements IMatrix2DM {
    ...
    public Matrix2DM(IMatrix2DC m) {
        this.m00 = m.m00(); this.m01 = m.m01(); this.m02 = m.m02();
        this.m10 = m.m10(); this.m11 = m.m11(); this.m12 = m.m12();
    }

    public Matrix2DM(IMatrix2FC m) {
        this.m00 = m.m00(); this.m01 = m.m01(); this.m02 = m.m02();
        this.m10 = m.m10(); this.m11 = m.m11(); this.m12 = m.m12();
    }
    ...
    @Override
    public IMatrix2DM set(IMatrix2FC matrix) {
        this.m00 = matrix.m00();
        this.m01 = matrix.m01();
        this.m02 = matrix.m02();
        this.m10 = matrix.m10();
    ...
    @Override
    public IMatrix2DM set(IMatrix2DC matrix) {
        this.m00 = matrix.m00();
        this.m01 = matrix.m01();
        this.m02 = matrix.m02();
        this.m10 = matrix.m10();
    ...
    @Override
    public IMatrix2DM mul(IMatrix2DC matrix) {
    ...
    @Override
    public IMatrix2DM mul(IMatrix2FC matrix) {
    ...
    @Override
    public IMatrix2DM mulPost(IMatrix2DC matrix) {
    ...
    @Override
    public IMatrix2DM mulPost(IMatrix2FC matrix) {
    ...
    @Override
    public IMatrix2DM scale(IVec2DC vec) {
        return this.scale(vec.x(), vec.y());
    }

    @Override
    public IMatrix2DM scale(IVec2IC vec) {
        return this.scale(vec.x(), vec.y());
    }
    ...
    @Override
    public IMatrix2DM translate(IVec2DC vec) {
        return this.translate(vec.x(), vec.y());
    }

    @Override
    public IMatrix2DM translate(IVec2IC vec) {
        return this.translate(vec.x(), vec.y());
    }
    ...
    @Override
    public IMatrix2DM rotateAround(IVec2DC point, double degrees) {
        return this.rotateAround(point.x(), point.y(), degrees);
    }

    @Override
    public IMatrix2DM rotateAround(IVec2IC point, double degrees) {
        return this.rotateAround(point.x(), point.y(), degrees);
    }
    ...
    @Override
    public int hashCode() {
        return Hasher.hash(this.m00, this.m01, this.m02, this.m10, this.m11, this.m12, 0.0D, 0.0D, 1.0D);
    }
}
